...
$CC $CFLAGS -o 1_1_polynomial_multiplication/sequential_polynomial_multiplication \
	1_1_polynomial_multiplication/sequential_polynomial_multiplication.c $LDFLAGS
$CC $CFLAGS -o 1_1_polynomial_multiplication/thread_polynomial_multiplication \
	1_1_polynomial_multiplication/thread_polynomial_multiplication.c $LDFLAGS

$CC $CFLAGS -o 1_2_shared_variable_update/seq_shared_var_up \
	1_2_shared_variable_update/seq_shared_var_up.c $LDFLAGS
$CC $CFLAGS -o 1_2_shared_variable_update/thread_shared_var_up \
...
$CC $CFLAGS -o 1_3_array_analysis/thread_arr_analysis \
...
$CC $CFLAGS -o 1_4_bank_simulation/thread_bank_sim \
	1_4_bank_simulation/thread_bank_sim.c $LDFLAGS

$CC $CFLAGS -o 1_5_barrier_implementations/cond_barrier_impl \
	1_5_barrier_implementations/cond_barrier_impl.c $LDFLAGS
$CC $CFLAGS -o 1_5_barrier_implementations/pthread_barrier_impl \
	1_5_barrier_implementations/pthread_barrier_impl.c $LDFLAGS
$CC $CFLAGS -o 1_5_barrier_implementations/sense_reversal_barrier_impl \
