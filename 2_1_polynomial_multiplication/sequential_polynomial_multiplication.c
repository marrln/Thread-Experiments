...
int main(int argc, char *argv[]) {
    ...
    // time_alloc,time_init,time_compute,time_verify,time_cleanup,time_total,verification
    printf("%f,%f,%f,%f,%f,%f,PASS\n",
        time_alloc, time_init, time_compute, 0.0, time_cleanup, time_total);
